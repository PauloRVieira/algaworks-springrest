...
public class OrdemServico {
	...
	@Valid
	@ConvertGroup(from = Default.class, to = ValidationGroups.Cliente.class)
	@NotNull
	@ManyToOne
//	@JoinColumn(name = "cliente_id")
	...
	public void finalizar() {
		if (jaFinalizada()) {
			throw new NegocioException("Ordem de Serviço já foi finalizada");
		}
